  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (indicators.length > 0) {
        // Tem indicadores cadastrados, usa o sistema normal
        ...
        // Não tem indicadores, usa campo de texto livre
        indicadoresValoresJson = JSON.stringify([{
          indicator_id: 0,
      ...
      await feedbackService.create({
        ...formData,
        indicadores_valores: indicadoresValoresJson,
      })
      ...
      {showForm && (
        <>
          <div className="card" style={{ background: 'linear-gradient(135deg, #0066cc 0%, #004c99 100%)', color: 'white', marginBottom: '1.5rem' }}>
            <h2 style={{ marginBottom: '1rem', color: 'white', textAlign: 'center', fontSize: '1.5rem' }}>
              FORMULÁRIO DE FEEDBACK INDIVIDUAL (ONE A ONE)
            </h2>
          ...
          <div className="card">
            <h2 style={{ marginBottom: '1.5rem', color: '#0066cc' }}>Criar Feedback</h2>
